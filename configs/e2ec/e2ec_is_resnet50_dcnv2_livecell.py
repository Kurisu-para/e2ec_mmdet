_base_ = [
    '../_base_/datasets/coco_livecell.py',
...
dataset_type = 'CocoLiveCellDataset'
data_root = '/home/dqwang/scratch/shaoyinkang/e2ec_mmdetection/data/livecell/'
img_norm_cfg = dict(
    mean=[128, 128, 128], std=[11.578, 11.578, 11.578])
#to_rgb=True
...
optimizer = dict(type='SGD', lr=0.02, momentum=0.9, weight_decay=0.0001) # 0.02*(16*10/16*8)=0.025
optimizer_config = dict(
    _delete_=True, grad_clip=dict(max_norm=35, norm_type=2))
# learning policy
