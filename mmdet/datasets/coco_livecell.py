...
from .api_wrappers import COCO, COCOeval, COCOExtendEval
from .builder import DATASETS
from .custom import CustomDataset


@DATASETS.register_module()
class CocoLiveCellDataset(CustomDataset):
    ...
    def evaluate_det_segm(self,
        ...
        for metric in metrics:
            ...
            cocoEval = COCOExtendEval(coco_gt, coco_det, iou_type)
            ...
            cocoEval.params.maxDets = [100, 500, 2000]

            cocoEval.params.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 18 ** 2], [18 ** 2, 31 ** 2], [31 ** 2, 1e5 ** 2]]
            ...
            if metric == 'proposal':
                ...
                print(f"Size parameters: {cocoEval.params.areaRng}")
