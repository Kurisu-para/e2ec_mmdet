...
coco = COCO('/home/sjtu/dataset/coco/annotations/instances_train2017.json',
            origin_img_dir='/home/sjtu/dataset/coco/train2017')               # 完整的coco数据集的图片和标注的路径
coco.build('./minicoco/mini_train2017', './minicoco/mini_instances_train2017.json', 240)  # 保存图片路径


coco = COCO('/home/sjtu/dataset/coco/annotations/instances_val2017.json',
            origin_img_dir='/home/sjtu/dataset/coco/val2017')                 # 完整的coco数据集的图片和标注的路径
coco.build('./minicoco/mini_val2017', './minicoco/mini_instances_val2017.json', 80)       # 保存图片路径
